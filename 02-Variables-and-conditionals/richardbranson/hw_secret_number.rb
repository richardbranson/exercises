...
def secret_number #define secret_number variable, containing while-loops and if-else statements
    ...
    until guess == number || guesses == 0   #while guess( method .to_i convert to integer) is less than variable number (is true)  AND guesses variable less than 3 (is true), enter this loop 
